<div class="panel panel-default">
						...
						<form action="insert37.php" method="post">
                            <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<?php
								$check= mysqli_query($link, "select * from tbl_subjavgf4t1 where subject='biology' ") ;
							...
							<?php
							$check= mysqli_query($link, "select * from tbl_subjavgf4t2 where subject='biology' ") ;
                                    while($row = mysqli_fetch_array($check)){
										$ex1=$row['ex1'];
										$ex2=$row['ex2'];
										$ex3=$row['ex3'];
							...
							<?php
							$check= mysqli_query($link, "select * from tbl_subjavgf4t3 where subject='biology' ") ;
                                    while($row = mysqli_fetch_array($check)){
										$ex1=$row['ex1'];
										$ex2=$row['ex2'];
										$ex3=$row['ex3'];
