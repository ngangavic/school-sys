                     ...
                     <?php if($_SESSION['role'] == "admin"){?>    
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="../positions">Calculate Positions</a>
                                </li>
						...
						<li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="index.php?id=1">Subject Averages</a>
                                </li>
                                <li>
...
<!--teachers-->				
                    <?php }else{?>
						...
						<li>
							<a href="../view grade/grade.php"><i class="fa fa-dashboard fa-fw"></i>View grade</a>
                        </li>
						<li>
						...
						<li>
							<a href="index.php?id=1"><i class="fa fa-dashboard fa-fw"></i>Subjects Averages</a>
                        </li>
						<li>
