<div class="panel panel-default">
                        <div class="panel-heading">
                            Agriculture Form 2 Term 3
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
						<form action="input_gradef2t3.php" method="post">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
	<?php
$viewRemarks=mysqli_query($link,"SELECT * FROM tbl_remarks where class='form 2' ");
...
$selectGrade = mysqli_query($link,"select * from tbl_agriculture_grade where class='form 2'");	
...
$query = mysqli_query($link,"select * from tbl_students where class='form 2'");
while($row=mysqli_fetch_array($query)){
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_agriculturef2t3 where adm='$adm2'");
...
<?php }}?>
							...
							<button name="agriculture" onClick="myAlert" class="btn btn-success pull-right" type="submit" value="Update">Submit</button>
							<script>
                                function myAlert(){
