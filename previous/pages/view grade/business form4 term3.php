...
$selectGrade = mysqli_query($link,"select * from tbl_business_grade where class='form 4'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_businessf4t3 where adm='$adm2'");
