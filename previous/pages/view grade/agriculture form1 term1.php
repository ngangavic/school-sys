<div class="panel panel-default">
                        <div class="panel-heading">
                            Agriculture Form 1 Term 1
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
						<form action="input_gradef1t1.php" method="post">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
	<?php
$viewRemarks=mysqli_query($link,"SELECT * FROM tbl_remarks where class='form 1' ");
...
$selectGrade = mysqli_query($link,"select * from tbl_agriculture_grade where class='form 1'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_agriculturef1t1 where adm='$adm2'");
