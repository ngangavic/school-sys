...
$selectGrade = mysqli_query($link,"select * from tbl_maths_grade where class='form 1'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_mathsf1t2 where adm='$adm2'");
