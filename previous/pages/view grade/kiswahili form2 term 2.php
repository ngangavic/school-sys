...
$selectGrade = mysqli_query($link,"select * from tbl_kiswahili_grade where class='form 2'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_kiswahilif2t2 where adm='$adm2'");
