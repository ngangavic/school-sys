...
$selectGrade = mysqli_query($link,"select * from tbl_business_grade where class='form 3'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_businessf3t1 where adm='$adm2'");
