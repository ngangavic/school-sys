...
$selectGrade = mysqli_query($link,"select * from tbl_chemistry_grade where class='form 2'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_chemistryf2t2 where adm='$adm2'");
...
<?php }}?>
							...
							<button name="chemistry" onClick="myAlert" class="btn btn-success pull-right" type="submit" value="Update">Submit</button>
							<script>
                                function myAlert(){
