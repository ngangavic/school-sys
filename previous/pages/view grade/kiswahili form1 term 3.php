<div class="panel panel-default">
                        <div class="panel-heading">
                            Kiswahili Form 1 Term 3
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
						<form action="input_gradef1t3.php" method="post">
...
$selectGrade = mysqli_query($link,"select * from tbl_kiswahili_grade where class='form 1'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_kiswahilif1t3 where adm='$adm2'");
