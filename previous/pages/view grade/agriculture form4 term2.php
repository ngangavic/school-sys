<div class="panel panel-default">
                        <div class="panel-heading">
                            Agriculture Form 4 Term 2
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
						<form action="input_gradef4t2.php" method="post">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
	<?php
$viewRemarks=mysqli_query($link,"SELECT * FROM tbl_remarks where class='form 4' ");
...
$selectGrade = mysqli_query($link,"select * from tbl_agriculture_grade where class='form 4'");	
...
$query = mysqli_query($link,"select * from tbl_students where class='form 4'");
while($row=mysqli_fetch_array($query)){
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_agriculturef4t2 where adm='$adm2'");
