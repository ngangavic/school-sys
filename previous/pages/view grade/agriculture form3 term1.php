<div class="panel panel-default">
                        <div class="panel-heading">
                            Agriculture Form 3 Term 1
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
						<form action="input_gradef3t1.php" method="post">
...
$selectGrade = mysqli_query($link,"select * from tbl_agriculture_grade where class='form 3'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_agriculturef3t1 where adm='$adm2'");
