...
$selectGrade = mysqli_query($link,"select * from tbl_english_grade where class='form 3'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_englishf3t1 where adm='$adm2'");
