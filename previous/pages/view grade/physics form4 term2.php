...
$selectGrade = mysqli_query($link,"select * from tbl_physics_grade where class='form 4'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_physicsf4t2 where adm='$adm2'");
