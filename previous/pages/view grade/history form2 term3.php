...
$selectGrade = mysqli_query($link,"select * from tbl_history_grade where class='form 2'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_englishf2t3 where adm='$adm2'");
