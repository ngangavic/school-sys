...
$selectGrade = mysqli_query($link,"select * from tbl_biology_grade where class='form 1'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_biologyf1t2 where adm='$adm2'");
