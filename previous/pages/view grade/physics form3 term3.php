...
$selectGrade = mysqli_query($link,"select * from tbl_physics_grade where class='form 3'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_physicsf3t3 where adm='$adm2'");
