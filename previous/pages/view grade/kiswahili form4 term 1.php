...
$selectGrade = mysqli_query($link,"select * from tbl_kiswahili_grade where class='form 4'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_kiswahilif4t1 where adm='$adm2'");
...
<?php }}?>
							...
							<button name="kiswahili" onClick="myAlert" class="btn btn-success pull-right" type="submit" value="Update">Submit</button>
							<script>
                                function myAlert(){
