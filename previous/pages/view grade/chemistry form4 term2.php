...
$selectGrade = mysqli_query($link,"select * from tbl_biology_grade where class='form 4'");	
...
$adm2=$row['adm'];		
$result = mysqli_query($link,"SELECT * FROM tbl_chemistryf4t2 where adm='$adm2'");
