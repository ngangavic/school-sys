...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Subject Teachers</h1>
					<div class="btn-group">
						<a href="subject teachers.php?id=1" type="submit" class="btn btn-danger">Form 1</a>
						<a href="subject teachers.php?id=2" type="submit" class="btn btn-success">Form 2</a>
						<a href="subject teachers.php?id=3" type="submit" class="btn btn-primary">Form 3</a>
					    <a href="subject teachers.php?id=4" type="submit" class="btn btn-warning">Form 4</a>
					</div>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                    ...
                    <div class="panel panel-default">
						...
						<form action="subject teachers exec.php" method="post">
                            <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
								<?php
                                 $result = mysqli_query($link,"SELECT * FROM tbl_sbj_teachers where class='form 1' ");
...
<?php } ?>
				...
				<?php }elseif($get_id==2){ include"subject teachers2.php";?>
				<?php }elseif($get_id==3){ include"subject teachers3.php";?>
				<?php }elseif($get_id==4){ include"subject teachers4.php";}?>
                    <!-- /.panel -->
                </div>
        <!-- /#page-wrapper -->
