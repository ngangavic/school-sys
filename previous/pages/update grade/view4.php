...
$view=mysqli_query($link,"SELECT * FROM tbl_english_grade where class='form 4' ");
...
$view=mysqli_query($link,"SELECT * FROM tbl_kiswahili_grade where class='form 4' ");
while($row=mysqli_fetch_array($view))
{
	$kisA=$row['A'];
...
$view=mysqli_query($link,"SELECT * FROM tbl_maths_grade where class='form 4' ");
while($row=mysqli_fetch_array($view))
{
	$matA=$row['A'];
...
$view=mysqli_query($link,"SELECT * FROM tbl_biology_grade where class='form 4' ");
while($row=mysqli_fetch_array($view))
{
	$bioA=$row['A'];
...
$view=mysqli_query($link,"SELECT * FROM tbl_chemistry_grade where class='form 4' ");
while($row=mysqli_fetch_array($view))
{
	$chemA=$row['A'];
...
$view=mysqli_query($link,"SELECT * FROM tbl_physics_grade where class='form 4' ");
while($row=mysqli_fetch_array($view))
{
	$phyA=$row['A'];
...
$view=mysqli_query($link,"SELECT * FROM tbl_geography_grade where class='form 4' ");
while($row=mysqli_fetch_array($view))
{
	$geoA=$row['A'];
...
$view=mysqli_query($link,"SELECT * FROM tbl_history_grade where class='form 4' ");
while($row=mysqli_fetch_array($view))
{
	$hisA=$row['A'];
...
$view=mysqli_query($link,"SELECT * FROM tbl_cre_grade where class='form 4' ");
while($row=mysqli_fetch_array($view))
{
	$creA=$row['A'];
...
$view=mysqli_query($link,"SELECT * FROM tbl_business_grade where class='form 4' ");
while($row=mysqli_fetch_array($view))
{
	$busA=$row['A'];
...
$view=mysqli_query($link,"SELECT * FROM tbl_agriculture_grade where class='form 4' ");
while($row=mysqli_fetch_array($view))
{
	$agriA=$row['A'];
