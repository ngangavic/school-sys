...
$update=mysqli_query($link,"UPDATE tbl_english_grade SET A='$englishA',Aminus='$englishAMINUS',Bplus='$englishBPLUS',B='$englishB',Bminus='$englishBMINUS',Cplus='$englishCPLUS',C='$englishC',Cminus='$englishCMINUS',Dplus='$englishDPLUS',D='$englishD',Dminus='$englishDMINUS',E='$englishE' WHERE class='form 1' ")or die(mysqli_error());
...
$update=mysqli_query($link,"UPDATE tbl_maths_grade SET A='$mathsA',Aminus='$mathsAMINUS',Bplus='$mathsBPLUS',B='$mathsB',Bminus='$mathsBMINUS',Cplus='$mathsCPLUS',C='$mathsC',Cminus='$mathsCMINUS',Dplus='$mathsDPLUS',D='$mathsD',Dminus='$mathsDMINUS',E='$mathsE' WHERE class='form 1' ")or die(mysqli_error());
$update=mysqli_query($link,"UPDATE tbl_biology_grade SET A='$biologyA',Aminus='$biologyAMINUS',Bplus='$biologyBPLUS',B='$biologyB',Bminus='$biologyBMINUS',Cplus='$biologyCPLUS',C='$biologyC',Cminus='$biologyCMINUS',Dplus='$biologyDPLUS',D='$biologyD',Dminus='$biologyDMINUS',E='$biologyE' WHERE class='form 1' ")or die(mysqli_error());
...
$update=mysqli_query($link,"UPDATE tbl_physics_grade SET A='$physicsA',Aminus='$physicsAMINUS',Bplus='$physicsBPLUS',B='$physicsB',Bminus='$physicsBMINUS',Cplus='$physicsCPLUS',C='$physicsC',Cminus='$physicsCMINUS',Dplus='$physicsDPLUS',D='$physicsD',Dminus='$physicsDMINUS',E='$physicsE' WHERE class='form 1' ")or die(mysqli_error());
...
$update=mysqli_query($link,"UPDATE tbl_history_grade SET A='$historyA',Aminus='$historyAMINUS',Bplus='$historyBPLUS',B='$historyB',Bminus='$historyBMINUS',Cplus='$historyCPLUS',C='$historyC',Cminus='$historyCMINUS',Dplus='$historyDPLUS',D='$historyD',Dminus='$historyDMINUS',E='$historyE' WHERE class='form 1' ")or die(mysqli_error());
$update=mysqli_query($link,"UPDATE tbl_cre_grade SET A='$creA',Aminus='$creAMINUS',Bplus='$creBPLUS',B='$creB',Bminus='$creBMINUS',Cplus='$creCPLUS',C='$creC',Cminus='$creCMINUS',Dplus='$creDPLUS',D='$creD',Dminus='$creDMINUS',E='$creE' WHERE class='form 1' ")or die(mysqli_error());
...
//$update=mysqli_query($link,"UPDATE tbl_english_grade SET A='$englishA',Aminus='$englishAMINUS' WHERE class='form 1' ")or die(mysqli_error());
