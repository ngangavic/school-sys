...
$sqlkis= mysqli_query($link, "select * from tbl_kiswahilif1t3 where adm='$stdadm' ") ;
...
$sqlmat= mysqli_query($link, "select * from tbl_mathsf1t3 where adm='$stdadm' ") ;
...
$sqlbio= mysqli_query($link, "select * from tbl_biologyf1t3 where adm='$stdadm' ") ;
...
$sqlphy= mysqli_query($link, "select * from tbl_physicsf1t3 where adm='$stdadm' ") ;
...
$sqlchem= mysqli_query($link, "select * from tbl_chemistryf1t3 where adm='$stdadm' ") ;
...
$sqlgeo= mysqli_query($link, "select * from tbl_geographyf1t3 where adm='$stdadm' ") ;
...
$sqlcomp= mysqli_query($link, "select * from tbl_computerf1t3 where adm='$stdadm' ") ;
...
$sqlcre= mysqli_query($link, "select * from tbl_cref1t3 where adm='$stdadm' ") ;
...
$sqlhis= mysqli_query($link, "select * from tbl_historyf1t3 where adm='$stdadm' ") ;
...
$sqlbus= mysqli_query($link, "select * from tbl_businessf1t3 where adm='$stdadm' ") ;
...
$sqlmus= mysqli_query($link, "select * from tbl_musicf1t3 where adm='$stdadm' ") ;
...
$sqlagri= mysqli_query($link, "select * from tbl_agriculturef1t3 where adm='$stdadm' ") ;
...
$sqlmean= mysqli_query($link, "select * from tbl_meanf1t3 where adm='$stdadm' ") ;
...
$sqlpos= mysqli_query($link, "select * from tbl_positonsf1t3 where adm='$stdadm' ") ;
...
$sqlmn= mysqli_query($link, "select * from tbl_lastmeanf1t3 where adm='$stdadm' ") ;
