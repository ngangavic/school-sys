...
$pdf->Ln(4);
$pdf->Cell(0,0,'CLASSLIST FORM 1 EXAM 2',0,0,'C');
//$pdf->Ln(8);
$pdf->Ln(0);
...
$sqlpos2= mysqli_query($link, "select * from tbl_positonsf1t3 where class='form 1' ORDER BY p2 ASC ");
...
$pdf->Cell(15,8,$total2, 0);
$pdf->Cell(4,8,$mean2, 0);
$pdf->Cell(8,8,$gr2, 0);
