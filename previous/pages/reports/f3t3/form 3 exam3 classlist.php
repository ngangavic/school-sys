...
$pdf->Ln(4);
$pdf->Cell(0,0,'CLASSLIST FORM 3 EXAM 3',0,0,'C');
//$pdf->Ln(8);
$pdf->Ln(0);
...
$sqlpos2= mysqli_query($link, "select * from tbl_positonsf3t3 where class='form 3' ORDER BY p3 ASC ");
