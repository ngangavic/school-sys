...
$yearNow=date('Y');	
$selectSubjAvg1=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='english' ")or die (mysqli_error());
...
$selectSubjAvg2=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='kiswahili' ")or die (mysqli_error());
...
$selectSubjAvg3=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='maths' ")or die (mysqli_error());
...
$selectSubjAvg4=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='biology' ")or die (mysqli_error());
...
$selectSubjAvg5=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='chemistry' ")or die (mysqli_error());
...
$selectSubjAvg6=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='physics' ")or die (mysqli_error());
...
$selectSubjAvg7=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='geography' ")or die (mysqli_error());
...
$selectSubjAvg8=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='history' ")or die (mysqli_error());
...
$selectSubjAvg9=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='cre' ")or die (mysqli_error());
...
$selectSubjAvg10=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='agriculture' ")or die (mysqli_error());
...
$selectSubjAvg11=mysqli_query($link,"SELECT * FROM tbl_subjavgf2t2 WHERE year='$yearNow' AND subject='business' ")or die (mysqli_error());
...
$selectClassAvg=mysqli_query($link,"SELECT * FROM tbl_classavgf2t2 WHERE year='$yearNow' ")or die (mysqli_error());
