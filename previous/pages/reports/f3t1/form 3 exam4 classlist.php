...
$pdf->Ln(4);
$pdf->Cell(0,0,'CLASSLIST FORM 3 AVERAGE',0,0,'C');
//$pdf->Ln(8);
$pdf->Ln(0);
...
$sqlpos2= mysqli_query($link, "select * from tbl_positonsf3t1 where class='form 3' ORDER BY p4 ASC ");
