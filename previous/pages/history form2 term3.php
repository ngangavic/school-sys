...
$adm2=$row['adm'];								
$result = mysqli_query($link,"SELECT * FROM tbl_historyf2t3 where adm='$adm2'");
...
<?php } }?>
							...
							<button name="history" class="btn btn-success pull-right" type="submit" value="Update">Update</button>
                            <!-- /.table-responsive -->
							</form>
                        </div>
                        <!-- /.panel-body -->
