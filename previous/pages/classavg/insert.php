...
//...................exam 3...............
$sqlmn3= mysqli_query($link, "select sum(mn3) from tbl_meanf1t1 where class='form 1' ") ;
...
//...................exam 4...............
$sqlmn4= mysqli_query($link, "select sum(mn4) from tbl_meanf1t1 where class='form 1' ") ;
...
$update=mysqli_query($link,"UPDATE tbl_classavgf1t1 SET ex1='$avg' WHERE year='$year'");		
	
$update=mysqli_query($link,"UPDATE tbl_classavgf1t1 SET ex2='$avg2' WHERE year='$year'");	

$update=mysqli_query($link,"UPDATE tbl_classavgf1t1 SET ex3='$avg3' WHERE year='$year'");	

$update=mysqli_query($link,"UPDATE tbl_classavgf1t1 SET ex4='$avg4' WHERE year='$year'");	
?>
<script>
window.location="index.php?id=1";
alert("Data updated.");
