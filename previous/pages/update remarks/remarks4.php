...
$update=mysqli_query($link,"UPDATE tbl_remarks SET A='$remarksA',Aminus='$remarksAminus',Bplus='$remarksBplus',B='$remarksB',Bminus='$remarksBminus',Cplus='$remarksCplus',C='$remarksC',Cminus='$remarksCminus',Dplus='$remarksDplus',D='$remarksD',Dminus='$remarksDminus',E='$remarksE' WHERE class='form 4' ")or die(mysqli_error());
